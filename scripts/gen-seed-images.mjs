// Generátor seed fotek v brand stylu (spouští se jednorázově, výstup se commituje).
// Použití: node scripts/gen-seed-images.mjs
...
const SUBJECTS = [
  { file: "dish-pasta", emoji: "🍝", bg: MUSTARD, label: "Fresh pasta" },
  { file: "dish-steak", emoji: "🥩", bg: CHERRY, label: "Dry aged" },
  { file: "dish-cake", emoji: "🍰", bg: TEAL, label: "Patisserie" },
  { file: "dish-coffee", emoji: "☕", bg: VINYL, label: "Flat white" },
  { file: "dish-cocktail", emoji: "🍹", bg: KETCHUP, label: "Signature" },
  { file: "dish-croissant", emoji: "🥐", bg: MUSTARD, label: "Butter 82%" },
  { file: "dish-ramen", emoji: "🍜", bg: TEAL, label: "Broth 48h" },
  { file: "dish-salad", emoji: "🥗", bg: CHERRY, label: "Green stuff" },
  { file: "dish-pizza", emoji: "🍕", bg: VINYL, label: "Napoli" },
  { file: "dish-wine", emoji: "🍷", bg: KETCHUP, label: "Natural" },
  { file: "dish-burger", emoji: "🍔", bg: MUSTARD, label: "Smash" },
  { file: "dish-oyster", emoji: "🦪", bg: TEAL, label: "Fine de claire" },
  { file: "place-bistro", emoji: "🍽️", bg: CHERRY, label: "Bistro U Chroma" },
  { file: "place-cafe", emoji: "☕", bg: TEAL, label: "Kavárna Pomáda" },
  { file: "place-bar", emoji: "🍸", bg: VINYL, label: "Bar Neon" },
  { file: "place-hotel", emoji: "🏨", bg: KETCHUP, label: "Hotel Imperial" },
];

function pageHtml({ emoji, bg, label }, w, h) {
  const light = bg === VINYL || bg === KETCHUP || bg === TEAL || bg === CHERRY;
